...
"""
Biden Extractor
Downloads YouTube video, isolates vocals, extracts all instances of "Biden"
"""
...
def extract_word_samples(vocals_file, target_word="biden", model_size="medium", padding_ms=100, pre_buffer_ms=1000):
    ...
    for segment in result['segments']:
        for word_info in segment.get('words', []):
            ...
            if target_word.lower() in word_clean:
                ...
                output_file = output_dir / f"biden_{sample_count:03d}_{timestamp}.wav"
    ...
    print(f"\n🎉 Extracted {sample_count} Biden samples!")
...
def main():
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
  python trump_biden.py "https://youtube.com/watch?v=..."
  python trump_biden.py "https://youtube.com/watch?v=..." --word trump
  python trump_biden.py "https://youtube.com/watch?v=..." --model small --padding 150
        """
    )
    
    parser.add_argument("url", help="YouTube URL")
    parser.add_argument("-w", "--word", default="biden", help="Word to extract (default: biden)")
    ...
    try:
        ...
        print("\n✨ Done! Load samples into Reason and make some Biden music!")
